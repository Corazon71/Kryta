        ...
        <AnimatePresence mode="wait">
            {displayTask ? (
                <motion.div
                    ...
                    className={`w-full backdrop-blur-xl border p-6 rounded-3xl shadow-[0_0_50px_rgba(124,58,237,0.4)] cursor-pointer group relative overflow-hidden transition-colors ${
                        displayTask.id === selectedTaskId 
            ...
            {tasks.map(task => {
                ...
                return (
                    <motion.div
                        ...
                        className={`absolute top-[35%] h-4 rounded-full cursor-pointer z-10 shadow-lg backdrop-blur-sm transition-all border ${
                            isSelected ? 'bg-white border-white shadow-[0_0_20px_white]' :
